...
public class FracturedChunk : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        HandleCollision(other, other.transform.position, otherRigidbody != null ? otherRigidbody.linearVelocity.magnitude : 0.0f);
    }
    ...
    void HandleCollision(Collider other, Vector3 v3CollisionPos, float relativeSpeed)
    {
        ...
        else
        {
            ...
            float   relativeSpeedFree = (otherVelocity - myRigidbody.linearVelocity).magnitude;
