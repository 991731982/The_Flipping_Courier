...
public class FracturedObjectEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(fracturedComponent.GUIExpandMain)
        {
            ...
            PropChunkPhysicMaterial.objectReferenceValue        = EditorGUILayout.ObjectField(new GUIContent("Chunk Physic Material",     "The physic material assigned to each chunk."), PropChunkPhysicMaterial.objectReferenceValue, typeof(PhysicsMaterial), true);
